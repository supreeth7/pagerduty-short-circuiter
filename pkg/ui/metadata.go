...
// SetAlertsSecondaryData initializes the text data for the secondary textview component of the UI for the alerts command.
...
// SetOncallSecondaryData initializes the text data for the secondary textview component of the UI for the oncall command.
